# SlapperParticlesV2
[![](https://poggit.pmmp.io/shield.state/SlapperParticlesV2)](https://poggit.pmmp.io/p/SlapperParticlesV2)
[![](https://poggit.pmmp.io/shield.api/SlapperParticlesV2)](https://poggit.pmmp.io/p/SlapperParticlesV2)<br>
...
It is plugin that Slappers has now particles!
...
- You can configure the plugin by accessing `plugin_data/SlapperParticlesV2/config.yml`

# Report a Issue/Bug
You found a bug or a plugin issue?
- Contact support in the [Discord Server](https://discord.gg/v2rNeHaptd)
- Create an [Issue](https://github.com/xqwtxon/SlapperParticlesV2/issues)
